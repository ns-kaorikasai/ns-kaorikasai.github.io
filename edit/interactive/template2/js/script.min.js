...
$(function(){var t=$('meta[property="og:url"]').attr("content")||$('link[rel="canonical"]').attr("href")||window.location.href,e=$('meta[property="og:title"]').attr("content")||$("title").text(),n=$('meta[property="og:site_name"]').attr("content");$.ajax({url:"https://graph.facebook.com/",dataType:"jsonp",data:{id:t}}).done(function(e){var n="undefined"==typeof e.shares?0:e.shares;$("#fbcount>.pageHeader_main_menu_list_item_count").text(n),$("#fbcount").fadeIn().on("click",function(){return window.open(this.href+"?u="+encodeURIComponent(t),"fbw","width=650 ,height=450").focus(),!1})}),$.ajax({url:"http://urls.api.twitter.com/1/urls/count.json",dataType:"jsonp",data:{url:t}}).done(function(t){var o="undefined"==typeof t.count?0:t.count;$("#ttcount>.pageHeader_main_menu_list_item_count").text(o),$("#ttcount").fadeIn().on("click",function(){var t=$(this).attr("data-hash")?" "+$(this).attr("data-hash"):"";return window.open(this.href+"?count=horizontal&text="+encodeURIComponent(e+"："+n+t)+"&url="+encodeURIComponent($(this).attr("data-url")),"ttw","width=550, height=450, personalbar=0,toolbar=0,scrollbars=1,resizable=1").focus(),!1})})});
$(function(){var i=$("nav.pageHeader_sub");$("#submenu").on("click",function(){i.is(":visible")?i.slideUp():i.slideDown()})});